...
import 'package:ecommerce_flutter_app/seller_screen/controllers/chat_controller.dart';
import 'package:ecommerce_flutter_app/seller_screen/services/store_services.dart';
import 'package:ecommerce_flutter_app/seller_screen/views/messages_screen/components/sender_bundle.dart';
...
class ChatScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    var controller = Get.put(ChatSellerController());
